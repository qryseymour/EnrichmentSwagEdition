ItemEvents.modification(event => {
    ...
    const oneStackItems = [
        ...
        'cozys-improved_cats:cat_collar',
        'cozys-improved_cats:ancient_cod',
        'cozys-improved_cats:ancient_salmon',
        'cozys-improved_cats:cooked_ancient_cod',
        'cozys-improved_cats:cooked_ancient_salmon',
